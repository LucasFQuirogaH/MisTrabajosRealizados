<%-- 
    Document   : Login
    Created on : 01/01/2022, 22:50:29
                    ...
                    <div class="main swiper-slide swiper-slide-next" id="savanna" data-swiper-slide-index="1" style="width: 1023px; transition-duration: 0ms; opacity: 0; transform: translate3d(-2046px, 0px, 0px);" role="group" aria-label="2 / 4">
                        <div class="left-side">
                            <div class="main-wrapper">
                                <h3 class="main-header">Bienvenidos</h3>
                                <h1 class="main-title">COMIENZO</h1>
                            </div>
                        ...
                        <div class="center">
                            <form action="SvEmpleado" method="POST">
                                ...
                                <input type="text" name="nombreUsu"><br>

                                <label>Contraseña: </label>
                                <input type="password" name="contrasenia"><br>

                                <input type="submit" value="Acceder Empleado"><br>
                                <a href="AltaEmpleado.jsp">Nuevo Empleado</button>
                            </form>
                        </div>
